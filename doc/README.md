...
- New option to cache job list for pipeline creation in ALM Octane
- The caching of Octane pipeline roots was implemented, to avoid sending non-relevant events/tasks/logs to ALM Octane
- Ability to execute UFT tests with parameters from ALM Octane
