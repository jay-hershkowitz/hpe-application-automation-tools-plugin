...
- Multiple dependencies updated – verify your Jenkins plugins compatibility with this plugin dependencies. To see the dependencies, go to [https://plugins.jenkins.io/hp-application-automation-tools-plugin/#dependencies) ](https://plugins.jenkins.io/hp-application-automation-tools-plugin/#dependencies). 
- Certified for Jenkins release 2.249.1

**ALM Octane**

- Ability to choose the folder for UFT Test Runner creation
- Ability to create auto-generated UFT jobs with SSH credentials
- Reduced name length of UFT Auto-Generated Test Runner jobs
- Added support for Configuration-as-code plugin to Octane configuration
- collectPullRequestsToAlmOctane pipeline step – is now supporting environment parameters for all fields (including credentialsId)

**UFT One**

- Migration of ALM credentials from task configuration page to global configuration
